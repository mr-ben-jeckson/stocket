<x-app-layout>
    ...
    <form action="{{ route('register') }}"
        ...
        <div class="mb-4">
            <x-text-input placeholder="Your name"
                    type="text"
                    name="name"
                    :value="old('name')"
        ...
        <div class="mb-4">
            <x-text-input placeholder="Your Email"
                    type="email"
                    name="email"
                    :value="old('email')"
        ...
        <div class="mb-4">
            <x-text-input placeholder="Password"
                    type="password"
                    name="password"
                    {{-- x-model="form.password" @input="validatePassword()"
        ...
        <div class="mb-4">
            <x-text-input placeholder="Repeat Password"
