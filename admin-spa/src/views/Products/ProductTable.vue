    ...
    <div class="bg-white p-4 rounded-lg shadow">
        ...
        <thead>
            <tr>
                ...
                <TableHeadingColumns @click="() => { return }" class="border-b-2 p-2 text-right" field=""
                    :sort-field="sortField" :sort-direction="sortDirection">
                    Image
                </TableHeadingColumns>
                ...
                <td class="border-b p-2">
                    <Menu as="div" class="relative inline-block text-left">
                        ...
                        <transition enter-active-class="transition duration-100 ease-out"
                            ...
                            <MenuItems class="absolute z-10 right-0 mt-2 w-32 origin-top-right divide-y divide-gray-100 rounded-md
